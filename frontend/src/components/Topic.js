    ...
    return (
      ...
      <section className="jumbotron text-center">
        <div className="container">
          ...
          <p className="lead text-muted">To view the topic feed for any of the topics listed below please click on the topic.  You can contribute to the feed or view previous posts.</p>
          <p>
